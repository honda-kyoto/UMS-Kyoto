<?php
/**********************************************************
* File         : med_work_regist_mgr.class.php
* Authors      : mie tsutsui
* Date         : 2013.01.10
...
require_once("sql/med_work_regist_sql.inc.php");
...
//	処理概要	：画面の共通関数クラス
//----------------------------------------------------------
class med_work_regist_mgr extends common_mgr
{
	...
	function getSearchArgs($request)
	{
		...
		if (@$request['kananame'] != "")
		{
			...
			$kananame = str_replace(" ", "", $kananame);
			////////////////2014/11/10 honda追加 小カナを大カナ変換 Start//////////////////////////
			$replace_of = array('ァ','ィ','ゥ','ェ','ォ','ャ','ュ','ョ','ッ');
	    	$replace_by = array('ア','イ','ウ','エ','オ','ヤ','ユ','ヨ','ツ');
			$kananame_zen = str_replace($replace_of, $replace_by, $kananame);//
			////////////////2014/11/10 honda追加 end///////////////////////////////////////////////
			$strBuff = "(";
			...
			$strBuff .= " OR ";
			////////////////2015/8/11 shibuta追加 旧姓検索 Start//////////////////////////
			$strBuff .= "UM.kanasei_real || UM.kanamei_real LIKE '%" . string::replaceSql($kananame) . "%'";
			$strBuff .= " OR ";
			$strBuff .= "UM.kanjisei_real || UM.kanjimei_real LIKE '%" . string::replaceSql($kananame) . "%'";
			$strBuff .= " OR ";
			$strBuff .= "UM.kyusei LIKE '%" . string::replaceSql($kananame) . "%'";
			$strBuff .= " OR ";
			////////////////2015/8/11 shibuta追加 旧姓検索 End//////////////////////////
			////////////////2014/11/10 honda追加 小カナを大カナ変換 Start///////////////////////////////
			$strBuff .= "UM.kanasei || UM.kanamei LIKE '%" . string::replaceSql($kananame_zen) . "%'";
			$strBuff .= " OR ";
			$strBuff .= "UM.kanjisei || UM.kanjimei LIKE '%" . string::replaceSql($kananame_zen) . "%'";
			$strBuff .= " OR ";
			////////////////2014/11/10 honda追加 end///////////////////////////////////////////////////
