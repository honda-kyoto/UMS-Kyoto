...
<!--
            <th scope="col"><a class="sortlink" href="javascript:sort('job_name');"><img src="<?php echo $mgr->getOrderData('src', 'job_name') ?>" alt="<?php echo $mgr->getOrderData('msg', 'job_name') ?>">職種</a></th>
-->
