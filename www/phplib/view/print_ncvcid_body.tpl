...
<h2 style="font-size:20px;">NCVCネット統合ID通知書</h2>
...
<tr>
  <td style="height: 40px;background: #CCC;border: #000 dashed 1px;font-weight:bold;font-size:14px;" align="center" colspan="6">NCVC&nbsp;ネット統合&nbsp;ID</td>
</tr>
<tr>
  <td style="border-color:#000;border-style:hidden hidden dashed dashed;border-width:1px;height: 40px;" width="20" align="center">&nbsp;</td>
  <td style="border-color:#000;border-style:hidden dashed dashed hidden;border-width:1px;font-size:14px;" width="120">統合ID</td>
...
<tr>
  <td style="height: 20px;border-color:#000;border-style:hidden dashed hidden;border-width:1px;font-size:13px;" align="left">
  &nbsp;&nbsp;&nbsp;&nbsp;利用者管理システムにログインし、<span style="background: #CCC;">仮パスワードの変更</span>と<span style="background: #CCC;">メールアドレスの作成</span>を
  </td>
</tr>
<tr>
  <td style="height: 20px;border-color:#000;border-style:hidden dashed hidden;border-width:1px;font-size:13px;" align="left">
...
<tr>
  ...
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;※利用者管理システムURL　　　http://ums.ncvc.local/
  </td>
</tr>
</table>
<div style="height: 20px;"></div>
<table cellpadding="2" cellspacing="0" style="width:600px;">
<tr>
  <td style="height: 20px;background: #CCC;border: #000 dashed 1px;font-weight:bold;font-size:14px;" align="center">ポータルサイト</td>
</tr>
<tr>
  <td style="height: 20px;border-color:#000;border-style:hidden dashed hidden;border-width:1px;font-size:13px;" align="left">
  URL　　http://portal.ncvc.local/
  </td>
</tr>
<tr>
...
<tr>
  <td style="height: 20px;border-color:#000;border-style:hidden dashed hidden;border-width:1px;font-size:13px;" align="left">
  上記URLにアクセスしていただき、右上のロゴをクリックしていただきますと、
  </td>
</tr>
<tr>
  <td style="height: 20px;border-color:#000;border-style:hidden dashed hidden;border-width:1px;font-size:13px;" align="left">
  各種ページに飛びますので、必要な方はご覧ください。
  </td>
</tr>
<tr>
  <td style="height: 20px;border-color:#000;border-style:hidden dashed hidden;border-width:1px;font-size:13px;" align="left">&nbsp;</td>
...
<tr>
  <td style="height: 20px;border-color:#000;border-style:hidden dashed hidden;border-width:1px;font-size:13px;" align="left">
  この統合ID / パスワードは、NCVCネット情報システムを利用する上で必要となりますので
  </td>
</tr>
<tr>
  <td style="height: 20px;border-color:#000;border-style:hidden dashed hidden;border-width:1px;font-size:13px;" align="left">
