...
-->
        <table width="100%" border="0" cellpadding="2" cellspacing="0" class="listTab" id="listTab">
          ...
          <tr class="nodrop nodrag">
            ...
            <td><input name="new_card_uid" type="text" id="new_card_uid" size="30" maxlength="16" value="<?php echo $mgr->getRequestData('new_card_uid') ?>" /></td>
            <td align="center">-</td>
...
<?php   foreach ($mgr->request['post_name'] AS $id => $data) { ?>
          <tr id="<?php echo $id; ?>">
            ...
            <td><input name="card_uid[<?php echo $id ?>]" type="text" id="card_uid_<?php echo $id ?>" value="<?php echo $mgr->getRequestData('card_uid', $id) ?>" size="30" maxlength="16" /></td>
