...
<?php   foreach ($mgr->request['sub_belong_chg_id'] AS $key => $dummy_id) { ?>
                      <tr>
                        ...
                        <td>
                          ...
                          <input name="sub_staff_id[<?php echo $key ?>]" type="text" id="sub_<?php echo $key ?>_staff_id" maxlength="<?php echo STAFF_ID_LEN ?>" value="<?php echo $mgr->getRequestData('sub_staff_id', $key) ?>" style="width:0; visibility:hidden;" />
