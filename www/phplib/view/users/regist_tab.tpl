            <table width="100%" border="0" cellpadding="5" cellspacing="0" class="inputTab">
              ...
              <tr>
                ...
                <td scope="col"><input name="staff_id" type="text" id="staff_id" size="6" maxlength="<?php echo STAFF_ID_LEN ?>" value="<?php echo $mgr->getRequestData('staff_id') ?>" />&nbsp;<span class="inputRule">(半角数字<?php echo STAFF_ID_LEN ?>桁以内)</span></td>
