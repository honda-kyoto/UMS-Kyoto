...
<?php } ?>
          ...
          <table width="100%" border="0" cellpadding="5" cellspacing="0" class="inputTab">
              ...
              <tr>
                ...
                <td colspan="3"><div class="CheckBoxTab">
                    <?php echo str_replace('<input', '<input disabled', $mgr->getCheckBoxList('user_role_id', 5)) ?>
                  </div></td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td colspan="3"><div class="CheckBoxTab">
                  <table border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      <td><input type="checkbox" name="ftrans_user_flg" id="ftrans_user_flg" value="1" <?php echo $mgr->getCheckData('ftrans_user_flg', '1') ?> disabled /></td>
                      <td><label for="ftrans_user_flg">ファイル転送機能を利用する</label></td>
                      <td>&nbsp;</td>
                      <td>
                        <select name="ftrans_user_kbn" id="ftrans_user_kbn" disabled>
...
<?php if ($mgr->getOutputData('is_retire_date')) { ?>
                      <td><span style="color : #cd5c5c;"><?php echo $mgr->getOutputData('end_date') ?></span></td>
<?php } else { ?>
