      ...
      <table border="0" cellpadding="2" cellspacing="0" class="searchTab">
        ...
        <tr>
          ...
          <td colspan="5">
<!--
            <select name="belong_class_id" id="belong_class_id" onchange="belongClassChange(this.value);" style="width:120px;">
...
-->
        ...
        <tr>
          <th width="80">利用者種別</th>
          <td colspan="5"><div class="CheckBoxTab">
            <?php echo $mgr->getCheckBoxList('user_type_id') ?>
          </div></td>
        </tr>
        <tr>
            ...
            <div class="CheckBoxTab">
              <table border="0" cellpadding="0" cellspacing="0">
                <tr>
                  ...
                  <td>&nbsp;</td>
                  <td><input type="radio" name="search_option" id="search_option_3" value="3" <?php echo $mgr->getCheckData('search_option', '3') ?> /></td>
                  <td><label for="search_option_3">期限切れ6ヶ月経過ユーザのみ表示</label></td>
                </tr>
            </table>
            </div>
          </td>
