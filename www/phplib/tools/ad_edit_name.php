...
$sql = "select UM.login_id,UM.login_passwd,UM.kanjisei,UM.kanjimei,UM.kanjisei || ' ' || UM.kanjimei as kanjiname,UM.kanasei,UM.kanamei,UM.kanasei || ' ' || UM.kanamei as kananame from user_mst as UM where UM.login_id is not null and UM.login_id != '' and UM.login_id = 'zheng.can.ri' order by UM.login_id";
...
//				print_r($login_id . '|' . $kanjisei .'|' . $kanjimei . '|' . $kanjiname .'|' . PHP_EOL);
//				print_r('更新は成功しました');
			}
			else
			{
