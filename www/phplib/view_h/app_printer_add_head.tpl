...
jQuery(function (){
	jQuery('select#tm_vlan_ridge_id').ieSelectWidth
		({
			containerClassName : 'select-container',
			overlayClassName : 'select-overlay'
		});

		jQuery('select#tm_vlan_floor_id').ieSelectWidth
		({
			containerClassName : 'select-container',
			overlayClassName : 'select-overlay'
		});

		jQuery('select#tm_vlan_room_id').ieSelectWidth
		({
			containerClassName : 'select-container',
			overlayClassName : 'select-overlay'
		});

		jQuery('select#dv_vlan_ridge_id').ieSelectWidth
		({
			containerClassName : 'select-container',
			overlayClassName : 'select-overlay'
		});

		jQuery('select#dv_vlan_floor_id').ieSelectWidth
		({
			containerClassName : 'select-container',
			overlayClassName : 'select-overlay'
		});

		jQuery('select#dv_vlan_room_id').ieSelectWidth
		({
			containerClassName : 'select-container',
			overlayClassName : 'select-overlay'
		});
...
{
	document.getElementById('terminal_id').selectedIndex = 0;
	formSubmit('input');
}
...
function resetDevice()
{
	...
	document.getElementById('tm_vlan_ridge_id').selectedIndex = 0;
	document.getElementById('tm_vlan_floor_id').selectedIndex = 0;
	document.getElementById('tm_vlan_room_id').selectedIndex = 0;
	document.getElementById('terminal_id').selectedIndex = 0;
	document.getElementById('dv_vlan_ridge_id').selectedIndex = 0;
	document.getElementById('dv_vlan_floor_id').selectedIndex = 0;
	document.getElementById('dv_vlan_room_id').selectedIndex = 0;
	document.getElementById('unallocated_only').checked = false;
	unselectAllDevice();
	formSubmit('input');
}
