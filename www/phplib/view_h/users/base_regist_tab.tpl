              ...
              <tr>
                ...
                <td scope="col" colspan="5"><div class="CheckBoxTab">
                  <table border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      <td><input name="staff_id" type="text" id="staff_id" size="6" maxlength="6" value="<?php echo $mgr->getRequestData('staff_id') ?>" />&nbsp;</td>
                      ...
                      <td>&nbsp;<span class="inputRule">(半角数字6桁　※職員番号のある方は職員番号を記入してください)</span></td>
                    </tr>
                  </table></div>
                </td>
              </tr>
