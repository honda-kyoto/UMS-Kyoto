...
-->
            ...
            <th scope="col">更新者</th>
<!--
<th scope="col"><a class="sortlink" href="javascript:sort('update_id');"><img src="<?php echo $mgr->getOrderData('src', 'update_id') ?>" alt="<?php echo $mgr->getOrderData('msg', 'update_id') ?>">更新者</a></th>
-->
            <th width="60" scope="col">詳細</th>
            </tr>
<?php $mgr->aryList_2 AS $update_id => $data['kanjisei'] ?>
