        ...
        <tr>
          <td valign="top"><table border="0" cellpadding="5" cellspacing="0" class="listTab">
			...
			<tr>
				...
				<td>標準</td>
				<td align="center"><input name="permission_37" type="checkbox" id="permission_37" value="1" <?php echo $mgr->getCheckData('permission_37', 1) ?> disabled /></td>
			</tr>
            <tr>
			...
			<tr>
				...
				<td>積貞棟地階<br />
				（給食部門 / 積・スタッフ）</td>
				<td align="center"><input name="permission_36" type="checkbox" id="permission_36" value="1" <?php echo $mgr->getCheckData('permission_36', 1) ?> disabled /></td>
			</tr>
            <tr>
            ...
            <tr>
              ...
              <td>外来診療棟４階<br />
				(高度生殖医療センター)</td>
              <td align="center"><input name="permission_39" type="checkbox" id="permission_39" value="1" <?php echo $mgr->getCheckData('permission_39', 1) ?> disabled /></td>
            </tr>
          ...
          <td valign="top"><table border="0" cellpadding="5" cellspacing="0" class="listTab">
            ...
            <tr>
              ...
              <td>R地下ロッカーM(男)</td>
              <td align="center"><input name="permission_29" type="checkbox" id="permission_29" value="1" <?php echo $mgr->getCheckData('permission_29', 1) ?> disabled /></td>
            </tr>
            <tr>
              <td align="center" valign="middle" style="height: 34px;">RF</td>
              <td>R地下ロッカーF(女)</td>
              <td align="center"><input name="permission_30" type="checkbox" id="permission_30" value="1" <?php echo $mgr->getCheckData('permission_30', 1) ?> disabled /></td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td>中央診療棟２階<br />
                （診療情報業務掛）</td>
              <td align="center"><input name="permission_40" type="checkbox" id="permission_40" value="1" <?php echo $mgr->getCheckData('permission_40', 1) ?> disabled /></td>
            </tr>
            ...
            <tr>
			  ...
			  <td>第１臨床研究棟地階 / ＊別途申請<br />
					 (建物外部扉）</td>
              <td align="center"><input name="permission_26" type="checkbox" id="permission_26" value="1" <?php echo $mgr->getCheckData('permission_26', 1) ?> disabled /></td>
            </tr>
          </table></td>
          <td>&nbsp;</td>
          <td valign="top"><table border="0" cellpadding="5" cellspacing="0" class="listTab">
            ...
            <tr>
              <td align="center" valign="middle" style="height: 34px;">先端</td>
				<td>先端センター<br />
					（先端のみ）</td>
              <td align="center"><input name="permission_27" type="checkbox" id="permission_27" value="1" <?php echo $mgr->getCheckData('permission_27', 1) ?> disabled /></td>
            </tr>
			<tr>
				<td align="center" valign="middle" style="height: 34px;">先EV</td>
				<td>先端センター<br />
				（EVのみ）</td>
				<td align="center"><input name="permission_28" type="checkbox" id="permission_28" value="1" <?php echo $mgr->getCheckData('permission_28', 1) ?> disabled /></td>
			</tr>

            <tr>
              <td align="center" valign="middle" style="height: 34px;">寮1</td>
              <td>看護師寮（北部）</td>
              <td align="center"><input name="permission_31" type="checkbox" id="permission_31" value="1" <?php echo $mgr->getCheckData('permission_31', 1) ?> disabled /></td>
            </tr>
            <tr>
              <td align="center" valign="middle" style="height: 34px;">寮2</td>
              <td>看護師寮（白眉）</td>
              <td align="center"><input name="permission_32" type="checkbox" id="permission_32" value="1" <?php echo $mgr->getCheckData('permission_32', 1) ?> disabled /></td>
            </tr>
            <tr>
              <td align="center" valign="middle" style="height: 34px;">寮3</td>
              <td>看護師寮（端穂）</td>
              <td align="center"><input name="permission_33" type="checkbox" id="permission_33" value="1" <?php echo $mgr->getCheckData('permission_33', 1) ?> disabled /></td>
            </tr>
            <tr>
              <td align="center" valign="middle" style="height: 34px;">寮M</td>
              <td>看護師寮マスター</td>
              <td align="center"><input name="permission_34" type="checkbox" id="permission_34" value="1" <?php echo $mgr->getCheckData('permission_34', 1) ?> disabled /></td>
            </tr>
            <tr>
              <td align="center" valign="middle" style="height: 34px; line-height: 92%;">K1-K3</td>
              <td>カードオプション<br />（共同機器研究室）</td>
              <td align="center"><input name="permission_35" type="checkbox" id="permission_35" value="1" <?php echo $mgr->getCheckData('permission_35', 1) ?> disabled /></td>
            </tr>
            <tr>
              <td colspan="3" align="center" style="background-color: #fff;"><img src="image/space.gif" alt="" width="10" height="10" /></td>
            </tr>
			<tr>
				...
				<td>全権限(99999999)</td>
				<td align="center"><input name="permission_38" type="checkbox" id="permission_38" value="1" <?php echo $mgr->getCheckData('permission_38', 1) ?> disabled /></td>
			</tr>
            <tr>
